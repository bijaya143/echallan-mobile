...
class HistoryBaseView extends StatefulWidget {
  const HistoryBaseView({super.key});

  @override
  State<HistoryBaseView> createState() => _HistoryBaseViewState();
}

class _HistoryBaseViewState extends State<HistoryBaseView> {
  @override
